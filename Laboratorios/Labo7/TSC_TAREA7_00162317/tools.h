...
void leerMallayCondiciones(mesh &m,char *filename){
    ...
    ifstream file;
    //Cambio 2
    float tau1,kappa2,lambda2, psi_fx2,psi_fy2,delta2,eta2;
    ...
    //Cambio 2
    file >> tau1 >> kappa2 >> lambda2 >> psi_fx2 >> psi_fy2 >> delta2 >> eta2;
    ...
    //Cambio 2
    m.setParameters((0.25)*tau1, kappa2, (2*2)/3, psi_fx2, psi_fy2, (0.125)*delta2, eta2);
